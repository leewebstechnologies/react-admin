      ...
      >
        {/* <div className="sidenav-header">
          ...
          <a className="navbar-brand m-0" href=" # " target="_blank">
            <img
              ...
              alt="main_logo"
            />
            <span className="ms-1 font-weight-bold">AI-DOMP</span>
          </a>
        </div> */}
        ...
        >
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
              <Link className="nav-link active" to="/property">
                <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <svg
                    width="12px"
                    height="12px"
            ...
            <li className="nav-item">
              <Link className="nav-link active" to="/create_sap">
                <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <svg
                    width="12px"
                    height="12px"
                ...
                <span className="nav-link-text ms-1">SAP</span>
              </Link>
            </li>

            <li className="nav-item">
              <Link className="nav-link  active" to="/create_mould">
                <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <svg
                    width="12px"
                    height="12px"
                ...
                <span className="nav-link-text ms-1">Mould RAG</span>
              </Link>
            </li>

            <li className="nav-item">
              <Link className="nav-link  active" to="/create_upgrade">
                <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <svg
                    width="12px"
                    height="12px"
                ...
                <span className="nav-link-text ms-1">Retrofit Upgrade</span>
              </Link>
            </li>

             <li className="nav-item">
              <Link className="nav-link  active" to="/property_details">
                <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <svg
                    width="12px"
                    height="12px"
                ...
                <span className="nav-link-text ms-1">Property Details</span>
              </Link>
            </li>
          </ul>
        </div>
